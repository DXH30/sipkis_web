        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                <span class="text-muted text-xs block">Adminstrator <b class="caret"></b></span>
                            </a>
                    ...
                    <li class="active">
                        <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Statistik</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?=base_url()?>index.php/password/change"><i class="fa fa-diamond"></i> <span class="nav-label">Ganti Password</span></a>
                    </li>
                </ul>
            </div>
        </nav>

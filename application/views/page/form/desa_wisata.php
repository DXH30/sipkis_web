...
<head>
    ...
    <title>SIPKIS | Form Desa Wisata</title>
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?= base_url() ?>index.php/form/desa_wisata">Form Isian Desa Wisata</a></li>
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <?php if (isset($edit)) : ?>
                                <form method="post" action="<?= base_url() ?>index.php/form/desa_wisata/4">
                                    <input type="hidden" name="id" value="<?= $id ?>">
                                <?php else : ?>
                                    <form method="post" action="<?= base_url() ?>index.php/form/desa_wisata/1">
                                    <?php endif ?>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Nama Desa Wisata</label>
                                        <div class="col-sm-10"><input type="text" name="nama_desa_wisata" class="form-control" value="<?php if (isset($nama_desa_wisata)) {
                                                                                                                                            echo $nama_desa_wisata;
                                                                                                                                        } ?>"></div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Alamat</label>
                                        <div class="col-sm-10"><input type="text" name="alamat" class="form-control" value="<?php if (isset($alamat)) {
                                                                                                                                echo $alamat;
                                                                                                                            } ?>"></div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Jumlah tenaga kerja</label>
                                        <div class="col-sm-10"><input type="text" name="jumlah_pekerja" class="form-control" value="<?php if (isset($jumlah_pekerja)) {
                                                                                                                                        echo $jumlah_pekerja;
                                                                                                                                    } ?>"></div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Jumlah tenaga kerja terdampak PHK</label>
                                        <div class="col-sm-10"><input type="text" name="jumlah_pekerja_phk" class="form-control" value="<?php if (isset($jumlah_pekerja_phk)) echo $jumlah_pekerja_phk; ?>"></div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control m-b" name="kondisi">
                                                ...
                                                <?php else : ?>
                                                    <option value="normal">normal</option>
                                                    <option value="terdampak" selected>terdampak</option>
                                                <?php endif ?> <option value="normal">normal</option>
                                                <option value="terdampak">terdampak</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            ...
                                            <a href="<?=base_url()?>index.php/form/tenaga_kerja_phk?tipe_id=2" class="btn btn-info">PHK</a>
                                        </div>
                                    </div>
                                    </form>
                        </div>

...
<head>
    ...
    <title>SIPKIS | Form Usaha Informal</title>
    ...
    <div id="wrapper">
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="<?= base_url() ?>index.php/form/usaha_informal">Form Isian Usaha Informal</a></li>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Form isian Usaha Informal</h2>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Form isian Usaha informal</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Form Isian Usaha Informal</h5>
                        ...
                        <div class="ibox-content">
                            <?php if (isset($edit)) : ?>
                                <form method="post" action="<?= base_url() ?>index.php/form/usaha_informal/4">
                                    <input type="hidden" name="id" value="<?= $id ?>">
                                <?php else : ?>
                                    <form method="post" action="<?= base_url() ?>index.php/form/usaha_informal/1">
                                    <?php endif ?>
                                    <div class="form-group row"><label class="col-sm-2 col-form-label">Pekerjaan (sektor pariwisata dan ekraf)</label>
                                        <div class="col-sm-10"><input type="text" name="pekerjaan" value="<?php if (isset($pekerjaan)) echo $pekerjaan; ?>" class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            ...
                                            <a href="<?= base_url() ?>index.php/form/tenaga_kerja_phk?tipe_id=4" class="btn btn-info">PHK</a>
                                        </div>
                                    </div>
                                    </form>
                        </div>
